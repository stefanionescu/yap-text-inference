...
_SAMPLING_FIELDS: tuple[tuple[str, type, float | int, float | int, str, str], ...] = (
    ("temperature", float, CHAT_TEMPERATURE_MIN, CHAT_TEMPERATURE_MAX,
     "invalid_temperature", "temperature_out_of_range"),
    ("top_p", float, CHAT_TOP_P_MIN, CHAT_TOP_P_MAX,
     "invalid_top_p", "top_p_out_of_range"),
    ("top_k", int, CHAT_TOP_K_MIN, CHAT_TOP_K_MAX,
     "invalid_top_k", "top_k_out_of_range"),
    ("min_p", float, CHAT_MIN_P_MIN, CHAT_MIN_P_MAX,
     "invalid_min_p", "min_p_out_of_range"),
    ("repetition_penalty", float, CHAT_REPETITION_PENALTY_MIN, CHAT_REPETITION_PENALTY_MAX,
     "invalid_repetition_penalty", "repetition_penalty_out_of_range"),
    ("presence_penalty", float, CHAT_PRESENCE_PENALTY_MIN, CHAT_PRESENCE_PENALTY_MAX,
     "invalid_presence_penalty", "presence_penalty_out_of_range"),
    ("frequency_penalty", float, CHAT_FREQUENCY_PENALTY_MIN, CHAT_FREQUENCY_PENALTY_MAX,
     "invalid_frequency_penalty", "frequency_penalty_out_of_range"),
)
    ...
    for field, caster, minimum, maximum, invalid_code, range_code in _SAMPLING_FIELDS:
        ...
        try:
            ...
            raise ValidationError(
                invalid_code, f"{field} must be a valid {caster.__name__}"
            ) from None
