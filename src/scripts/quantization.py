"""Utilities invoked by quantization shell scripts.

Provides CLI commands for downloading models and running quantization pipelines.
Works with both TensorRT-LLM and vLLM quantization workflows.
"""
...
def run_quantization(
    ...
    """Execute a quantization script with patches and noise suppression applied."""
