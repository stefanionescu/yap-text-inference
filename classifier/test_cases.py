TESTS = [
    ...
    ("take one pic", True),
    ("take 1 pic", True),
    ("can you take one pic?", True),
    ("can you take 1 pic?", True),
    ("please take one pic", True),
    ("please take 1 pic", True),
    ("I need one pic", True),
    ("I need 1 pic", True),
    ("take one image", True),
    ("take 1 image", True),
    ("can you take one image?", True),
    ("can you take 1 image?", True),
    ("please take one image", True),
    ("please take 1 image", True),
    ("I need one image", True),
    ("I need 1 image", True),
    ("can you take one shot?", True),
    ("can you take 1 shot?", True),
    ("please take one shot", True),
    ("please take 1 shot", True),
    ("take one snap", True),
    ("take 1 snap", True),
    ("can you take one snap?", True),
    ("can you take 1 snap?", True),
    ("please take one snap", True),
    ("please take 1 snap", True),
