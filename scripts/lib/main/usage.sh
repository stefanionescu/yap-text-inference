...
show_usage() {
  ...
  echo "  (or any compatible transformers sequence classification repo/path)"
  echo ""
  ...
  echo ""
  echo "  # 4-bit AWQ for chat (tool model stays float)"
  ...
  echo ""
  echo "Quantized model uploads (mutually exclusive):"
  ...
  echo "  NOTE: --push-quant and --push-engine cannot be used together"
  echo ""
  echo "Debugging:"
