...
apply_limits_and_timeouts() {
  ...
  # Tool model max context length (Toolcall). 3650 allows for 2400 system + 900 history tokens + 350 user
  ...
  export TOOL_PROMPT_MAX_TOKENS=${TOOL_PROMPT_MAX_TOKENS:-2400}   # System prompt
