...
# - Runs warmup, then bench at model's max batch size
...
# e.g. SERVER_READY_TIMEOUT_SECONDS=600 bash scripts/runtime/warmup.sh
...
# Bench workloads per voice - use actual max batch size
declare -a TARGETS=("$MAX_BATCH")
