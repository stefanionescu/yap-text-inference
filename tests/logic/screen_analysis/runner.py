"""Screen analysis test runner for toolcall → followup flow.

This module provides the run_once function that tests the complete screen
analysis flow: initial request triggering a toolcall YES, followed by a
followup message with analysis text. Reports timing metrics for both phases.
"""
...
async def run_once(
    ...
    Raises:
        RuntimeError: If toolcall is not YES or if server returns an error.
    """
