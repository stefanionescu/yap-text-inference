...
- USER SAYS SWITCHING WITHOUT INDICATION OF LOOKING AT THE SCREEN: "switching subjects" (with no other deictic or indication you should look at the screen) or "switching to English", "switching to X" (again if no other indication of having to check the screen)
...
- DEICTIC QUESTION (any question with this/that about something unknown): "is this good?", "thoughts on this?", "how does this look?", "Am I in the right here?", "what do you think about this?", "what do you think about this?", "Can you see if I'm right?", "isn't it awesome?", "isn't this awesome?", "what's your take on this?". IMPORTANT that things like "I like blue, what do you think?" are dependent on context. "I like blue, what do you think?" most likely returns [] because the user does not refer to something on the screen. 
...
- DEICTIC EXCLAMATION: "this is interesting", "this is crazy", "this is sick", "So cool!", "This is sick!", "that dog is so cute", "this is adorable" ONLY IF this is not a reaction to what you and the user were already talking about.
- HERE + LOOK: "Here, look", "Here, look."
- RESUMPTION: "Okay look now", "Just kidding, look now!", "Okay now" (after saying you should not look yet)
