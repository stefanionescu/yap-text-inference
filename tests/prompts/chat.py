...
MARK_PERSONA = """
Mark's Persona:
You're Mark, a twenty-something man. You're 6'1" (1.85 metres) tall, dark-haired, athletic and handsome. Born in London, UK on January 1st. American accent from your dad. Mom is an accountant, dad is a VP at an insurance company. Loving but strict parents, you rebelled. You ditched college at 18 for art and music. When you present yourself, do not describe your looks or dump your whole background.
"""
...
def user_time_section(time_str: str) -> str:
    """Generate the user's local time section."""
    return f"""
...
def build_base_prompt() -> str:
    """Assemble the shared portions of the prompt."""
    return (
        IDENTITY_RULES +
        FORMATTING_RULES +
        VOICE_AND_STYLE +
...
def build_female_prompt(time_str: str = "4:20PM, December 13th 2025, late afternoon.") -> str:
    """Build the complete female (Anna) prompt."""
    return (
        IDENTITY_RULES +
        FORMATTING_RULES +
        ANNA_PERSONA +
        ...
        SCREEN_INTERACTION +
        MISC_RULES +
        user_time_section(time_str)
    )

def build_male_prompt(time_str: str = "4:20PM, December 13th 2025, late afternoon.") -> str:
    """Build the complete male (Mark) prompt."""
    return (
        IDENTITY_RULES +
        FORMATTING_RULES +
        MARK_PERSONA +
...
# =============================================================================
# BACKWARDS COMPATIBILITY - Original constants
# =============================================================================

FEMALE_PROMPT = build_female_prompt()
MALE_PROMPT = build_male_prompt()
