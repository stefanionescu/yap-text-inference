...
DATA = [
    ...
    (
        ...
        [
            ("I just watched a 4 hour video essay about the fall of a Minecraft server and it was peak cinema.", False),  # noqa: E501
            ...
            (
                "See this runtime right here? Five hours and twenty three minutes. On a kids' game. I love the internet.",  # noqa: E501
                True,
            ),
            (
