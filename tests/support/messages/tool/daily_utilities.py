...
DATA = [
    ...
    (
        ...
        [
            ...
            (
                "Ok, so Jake had the steak which was 34 and Emma had a salad for 12. That's already not fair to split evenly.",  # noqa: E501
                False,
            ),
    ...
    (
        ...
        [
            ...
            ("Should we just move it inside or risk it? Because last time we moved it and it didn't even rain.", False),  # noqa: E501
    ...
    (
        ...
        [
            (
                "I went into my phone settings for one thing and now I've been in here for 40 minutes discovering stuff.",  # noqa: E501
                False,
            ),
            ...
            ("Ok, fixed it. But look at this other thing I found. Back tap to screenshot. That's actually sick.", True),  # noqa: E501
