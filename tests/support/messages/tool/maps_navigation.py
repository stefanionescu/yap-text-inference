...
DATA = [
    ...
    (
        ...
        [
            ...
            (
                "The sign said Terminal B but my boarding pass says B2, which is apparently a whole different building.",  # noqa: E501
                False,
            ),
            ...
            (
                "See this gate number? It's all the way at the end of the terminal, obviously, because why wouldn't it be.",  # noqa: E501
                True,
            ),
        ],
    ),
    ...
    (
        ...
        [
            ...
            (
                "Update: he called me and asked for directions to my apartment, which is wild because the app gives them to you.",  # noqa: E501
                False,
            ),
        ],
    ),
    ...
    (
        ...
        [
            (
                "Ok so I'm in Tokyo for the first time and Google Maps walking directions are both saving and confusing me.",  # noqa: E501
                False,
            ),
            ...
            ("The street names don't match what's on the signs here because everything is in kanji, obviously.", False),  # noqa: E501
