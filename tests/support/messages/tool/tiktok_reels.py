...
DATA = [
    ...
    (
        ...
        [
            (
                "Bro, my FYP is literally reading my mind right now. I was JUST talking about buying an air fryer and now every other video is air fryer content.",  # noqa: E501
                False,
            ),
    ...
    (
        ...
        [
            (
                "Yo, I just opened TikTok and the first thing on my FYP is some dude eating a raw onion like an apple. What is wrong with people?",  # noqa: E501
                False,
            ),
            ("I can't stop watching mukbangs lately. It's becoming a problem, to be honest.", False),
            (
                "Look at the size of this plate, bruh. That's like 8 pounds of noodles. No human should eat that in one sitting.",  # noqa: E501
                True,
            ),
            ("The sounds are so gross but I literally cannot scroll away. I don't know what's wrong with me.", False),
            (
                "This part right here where he just inhales the entire lobster tail in one bite. I'm going to be sick.",  # noqa: E501
                True,
            ),
            (
            ...
            (
                "I swear to God, TikTok is rotting my brain, but here I am at 3am watching someone eat 50 chicken wings.",  # noqa: E501
                False,
            ),
        ],
    ),
    ...
    (
        ...
        [
            (
                "BookTok has completely taken over my FYP and honestly I'm not mad about it. I haven't read this much since high school.",  # noqa: E501
                False,
            ),
            (
                "See, this girl is literally sobbing over the ending of Fourth Wing and now I need to read it immediately.",  # noqa: E501
                True,
            ),
            ...
            (
                "Not going to lie, some of these recommendations are lowkey mid though. Not everything BookTok hypes up is actually good.",  # noqa: E501
                False,
            ),
    ...
    (
        ...
        [
            (
                "I just found the longest duet chain I've ever seen on TikTok and each one gets progressively more unhinged.",  # noqa: E501
                False,
            ),
    ...
    (
        ...
        [
            ...
            (
                "I miss when TikTok sounds were actually creative and not just the same three audios recycled forever.",  # noqa: E501
                False,
            ),
    ...
    (
        ...
        [
            ...
            (
                "The video made it look like a five minute thing but I was in the kitchen for two hours and it still looked wrong.",  # noqa: E501
                False,
            ),
    ...
    (
        ...
        [
            ...
            (
                "Earlier I saw a cat that kept slapping its owner every time they tried to work. Dead serious, the funniest thing I've seen all week.",  # noqa: E501
                False,
            ),
    ...
    (
        ...
        [
            (
                "Okay, so there is MASSIVE beef happening on TikTok right now between these two creators and it's getting ugly.",  # noqa: E501
                False,
            ),
            ...
            (
                "Then this comment right here from the other one saying receipts are coming had everyone lose their minds.",  # noqa: E501
                True,
            ),
            ("The stitch where she exposes the DMs though. Look at what he actually said vs what he claimed.", True),
            (
                "Not going to lie, I don't even follow either of them, but TikTok drama is my guilty pleasure. I can't look away.",  # noqa: E501
                False,
            ),
        ],
    ),
    ...
    (
        ...
        [
            ...
            (
                "And this pressure washing video, oh my God. Look at the difference between the left side and the right side.",  # noqa: E501
                True,
            ),
            (
                "I don't know why my brain craves this content so much, but I physically cannot scroll past these videos.",  # noqa: E501
                False,
            ),
    ...
    (
        ...
        [
            ...
            (
                "Like look at this product. There's no way this actually works. It's literally a flashlight that claims to remove wrinkles.",  # noqa: E501
                True,
            ),
            (
                "And the reviews are all clearly fake. Have you noticed that every TikTok Shop review sounds exactly the same?",  # noqa: E501
                False,
            ),
            (
                "This creator used to make normal content but now every video is just an ad for random stuff. It's sad, honestly.",  # noqa: E501
                False,
            ),
            (
                "Check this one out though. 90 percent off a designer bag? Yeah, okay, sure buddy. That's definitely real.",  # noqa: E501
                True,
            ),
            (
                "They always put ad in tiny letters at the top but design the whole video to look organic, which feels scammy.",  # noqa: E501
                False,
            ),
            (
                "I'm convinced half these products are just AliExpress stuff with a 300 percent markup, not going to lie.",  # noqa: E501
                False,
            ),
        ],
    ),
    ...
    (
        ...
        [
            (
                "Okay, but Reels is literally just recycled TikTok content like three weeks later. I will die on this hill.",  # noqa: E501
                False,
            ),
            ("See this reel right here? I saw the exact same video on TikTok last month with way more views.", True),
            (
                "The algorithm on Reels is trash too. It keeps showing me stuff from 2024. Like, hello, update please.",  # noqa: E501
                False,
            ),
            (
                "TikTok just hits different though. The editing, the sounds, the duets. Reels doesn't have that energy.",  # noqa: E501
                False,
            ),
            (
                "Look at this side by side. Same creator posted on both and the TikTok version has 10x the engagement.",  # noqa: E501
                True,
            ),
            (
                "To be honest, I use both, but only because Reels is right there when I open Instagram. It's not like I go looking for it.",  # noqa: E501
                False,
            ),
        ],
    ),
    ...
    (
        ...
        [
            (
                "Dark humor TikTok at 4am hits completely different. I am laughing at things that should not be funny.",  # noqa: E501
                False,
            ),
    ...
    (
        ...
        [
            (
                "I am so addicted to GRWM videos even though my own routine is literally just splash water on face and leave.",  # noqa: E501
                False,
            ),
            (
                "This girl has a 47 step skincare routine and her skin looks exactly the same as mine. Make it make sense.",  # noqa: E501
                True,
            ),
            (
                "The aesthetic is immaculate though, not going to lie. Like everything is color coordinated and the lighting is perfect.",  # noqa: E501
                False,
            ),
            (
                "See this part where she does her eyeliner in one stroke? I could never. That takes me twenty minutes minimum.",  # noqa: E501
                True,
            ),
            (
                "These routines are so unrealistic. Nobody actually wakes up at 5am to journal and do yoga and make a smoothie bowl every single day.",  # noqa: E501
                False,
            ),
            (
                "But look at this one. She's actually real about it. Messy room, coffee stain on her shirt. That's more like it.",  # noqa: E501
                True,
            ),
            (
