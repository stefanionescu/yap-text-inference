...
log_info ""
log_info "# Run with pre-quantized AWQ models (both chat and tool)"
...
log_info ""
log_info "# Run chat-only deployment"
log_info "docker run -d --gpus all --name yap-chat \\"
log_info "  -e AWQ_CHAT_MODEL=your-org/chat-awq \\"
log_info "  -e DEPLOY_MODELS=chat \\"
log_info "  -p 8000:8000 \\"
log_info "  ${FULL_IMAGE_NAME}"
log_info ""
log_info "# Run with sequential model calls (lower resource usage)"
log_info "docker run -d --gpus all --name yap-sequential \\"
log_info "  -e AWQ_CHAT_MODEL=your-org/chat-awq \\"
log_info "  -e AWQ_TOOL_MODEL=your-org/tool-awq \\"
log_info "  -e CONCURRENT_MODEL_CALL=0 \\"
log_info "  -p 8000:8000 \\"
log_info "  ${FULL_IMAGE_NAME}"
log_info ""
log_info "Health check: curl http://localhost:8000/healthz"
