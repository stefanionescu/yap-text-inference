...
usage() {
  ...
  echo "  CHAT_GPU_FRAC                   - GPU memory fraction for chat model (default: 0.71 both / 0.92 single)"
  echo "  TOOL_GPU_FRAC                   - GPU memory fraction for tool model (default: 0.21 both / 0.92 single)"
  echo ""
  echo "Examples:"
  echo "  # Both models"
