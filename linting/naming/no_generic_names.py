...
FORBIDDEN_PREFIXES = [str(value) for value in _NAMING.get("forbidden_prefixes", []) if isinstance(value, str)]
FORBIDDEN_SUFFIXES = [str(value) for value in _NAMING.get("forbidden_suffixes", []) if isinstance(value, str)]
FORBIDDEN_FUNCTION_NAMES = {
    str(value) for value in _NAMING.get("forbidden_function_names", []) if isinstance(value, str)
}
ALLOWED_PATH_PREFIXES = [str(value) for value in _NAMING.get("allowed_path_prefixes", []) if isinstance(value, str)]
